...
public class DepartmentService {
    ...
    public DepartmentService(FacultyRepository facultyRepository) {
        this.facultyRepository = facultyRepository;
    }

    public List<Department> getAllDepartments() {
        return List.of(
                new Department("Computer Science and Engineering", "CSE", getFacultyByDepartment("CSE")),
                new Department("Electronics and Communication Engineering", "ECE", getFacultyByDepartment("ECE")),
                new Department("Information Technology", "IT", getFacultyByDepartment("IT")),
                new Department("Artificial Intelligence and Machine Learning", "AIML", getFacultyByDepartment("AIML")),
                new Department("Computer Science and Management", "CSM", getFacultyByDepartment("CSM")),
    ...
    public Department getDepartmentByCode(String code) {
        List<Faculty> facultyList = getFacultyByDepartment(code);
        return new Department(getDepartmentName(code), code, facultyList);
    }

    private List<Faculty> getFacultyByDepartment(String departmentCode) {
        return facultyRepository.findByDepartment(departmentCode);
    }
    ...
    private String getDepartmentName(String code) {
        switch (code) {
            ...
            case "AIML": return "Artificial Intelligence and Machine Learning";
            case "CSM": return "Computer Science and Management";
            case "CSC": return "Computer Science and Cyber Security";
            case "CSD": return "Computer Science and Design";
            case "EEE": return "Electrical and Electronics Engineering";
            case "MECH": return "Mechanical Engineering";
            case "CSIT": return "Computer Science and Information Technology";
